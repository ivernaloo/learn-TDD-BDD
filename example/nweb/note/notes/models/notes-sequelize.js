...
exports.events = require('./notes-events'); // expose the event to global
...
exports.create = function(key, title, body) {
    ...
    .then(newnote => {
        exports.events.noteCreated({ // bring object with event trigger
            key: newnote.key,
            title: newnote.title,
            body: newnote.body
        });
...
exports.update = function(key, title, body) {
    ...
    .then(newnote => {
        exports.events.noteUpdate({ // broadcast to the global and notification to the handler
            key,
            title: newnote.title,
            body: newnote.body
        });
