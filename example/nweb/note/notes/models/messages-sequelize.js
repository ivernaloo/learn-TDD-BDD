...
var connectDB = function() {
    ...
    .then(params => {
        ...
        if (!sequlz) sequlz = new Sequelize(params.dbname, params.username, params.password, params.params); // define the object pattern
        ...
        return SQMessage.sync(); // message instance store in the database
    });
};
