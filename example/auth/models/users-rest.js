...
var connectREST = function() {
    return new Promise((resolve, reject) => {
        try {
            resolve(restify.createJsonClient({ // chain syntax to to build the api
    ...
    .then(client => {
        client.basicAuth('them', 'D4ED43C0-8BD6-4FE2-B358-7C0E230D11EF'); // auth
        return client;
...
exports.create = function(username, password, provider, familyName, givenName, middleName, emails, photos) {
    return connectREST().then(client => {
        return new Promise((resolve, reject) => {
            client.post('/create-user', { // create object
